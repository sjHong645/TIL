### 구현 출처 : [인접 리스트 그래프](https://github.com/sponbob-pat/TIL/blob/main/CodingTest/%EA%B7%B8%EB%9E%98%ED%94%84(Graph)/%EA%B4%80%EB%A0%A8%EB%82%B4%EC%9A%A9/%EC%9D%B8%EC%A0%91%EB%A6%AC%EC%8A%A4%ED%8A%B8%EA%B8%B0%EB%B0%98%EA%B7%B8%EB%9E%98%ED%94%84%EA%B5%AC%ED%98%84.md), [인접 행렬 그래프](https://github.com/sponbob-pat/Java/blob/master/src/main/java/com/thealgorithms/datastructures/graphs/MatrixGraphs.java)
...
`n개의 트리`에서 `간선`을 하나 제거하면 `n+1개의 트리`가 된다. 
